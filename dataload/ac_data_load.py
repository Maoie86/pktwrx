...
cassandra_host = ['192.168.97.252']  # Replace with your Cassandra host(s)
...
payload_dict = {
    ...
    #"Active_Energy_Net" : "energy",
    #"Active_Power_L1" : "energy",
    #"Active_Power_L2" : "energy",
    #"Active_Power_L3" : "energy",
    #"Active_Power_L4" : "energy",
    #"Active_Power_L5" : "energy",
    #"Active_Power_L6" : "energy",
    # "Active_Power_Total_2" : "energy",
    ...
    #"Frequency" : "frequency",
    #"Import_Active_Energy_L3" : "energy",
    "LLVD1_Voltage" : "voltage_L1",
    "Load_Voltage" : "voltage_L1",
    "Mains_total_watts" : "energy",
    "Positive_Active_Energy_Total" : "energy",
    #"Positive_Active_Energy_L1" : "energy",
    #"Positive_Active_Energy_L2" : "energy",
    #"Positive_Active_Energy_L3" : "energy",
    #"Positive_Active_Energy_L4" : "energy",
    #"Positive_Active_Energy_L5" : "energy",
    #"Positive_Active_Energy_L6" : "energy",
    #"Positive_Active_Energy_L7" : "energy",
    #"Positive_Active_Energy_L8" : "energy",
    #"Positive_Active_Energy_L9" : "energy",
    #"Positive_Active_Energy_L10" : "energy",
    #"Positive_Active_Energy_L11" : "energy",
    #"Positive_Active_Energy_L12" : "energy",
...
def call_load_sql():
    ...
    if row_count > 0:
        try:
            ...
            data_batch = BatchStatement(consistency_level=ConsistencyLevel.ONE)
            latest_batch = BatchStatement(consistency_level=ConsistencyLevel.ONE)
            # print("rows:" + row_count, datetime.now())
...
def pt_to_db(payload):
    ...
    try:
        ...
        print("An exception occurred 333:", error)
    ...
    try:
        ...
        #print("An exception occurred 444:", error)
        tserror = 1
        pass
    if tserror == 1:
        ts_str = payload["uplink_message"]["received_at"].split("Z")[0][0:26]
    ...
    try:
        ...
        print("An exception occurred 555:", error)
        pass
    ...
    try:
        ...
        print("An exception occurred 111:", error)
    ...
    with open(file_name,'a') as temp_file: #, open(other_file_name,'a') as other_temp_file:
        for key, value in payload["uplink_message"]["decoded_payload"].items():
            ...
            if isinstance(value, (int, float)) :  
                ...
                #if application_id == 'pt_iaq':
                #print(f"{row_count}: {dev_eui}, {key}, {value}, {application_id}, {ts}")
                try:
                    #print("aaaaaaaa")
                    ...
                    #print(".", end="")
                    #print("An exception occurred 222:", error, key)
                    continue
            #else:
